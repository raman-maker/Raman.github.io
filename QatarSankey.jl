...
using SankeyPlots ,Colors, ColorSchemes,PlutoUI, HypertextLiteral; import PlotUtils: palette

# ╔═╡ f8856a20-2de6-4f3f-9008-9dc288f0aa01
Resource("https://julialang.org/assets/images/benchmarks.svg?raw=true" ,:width=>700)

# ╔═╡ 43c0fdb7-6827-4055-951e-72c5cffd4dcf
@htl("""
	<style>
	.cool-class {
		font-size: 5.3rem;
	...
	<div class="cool-class">⭐️QATAR🌍</div>
	""")

# ╔═╡ 0b9ccfa3-a504-4910-9745-909e3d997082
Resource("https://upload.wikimedia.org/wikipedia/commons/d/d4/QAT_orthographic.svg?raw=true", :width=>500)

# ╔═╡ ceb97b40-fd62-4556-aa26-d971d2403550
md"  # ⭐[**QATAR**](https://en.wikipedia.org/wiki/Qatar)

> Qatar is _one fourth_ the size of Haryana. 
>
> Qatar is the fourth largest country by greenhouse gas emissions per capita based on a production accounting of emissions of Carbon dioxide, Methane, Nitrous oxide, Perfluorocarbon, Hydrofluorocarbon, and Sulfur hexafluoride within the territory of country. 
>
>Carbon dioxide emissions per person average over 30,000 Kg - weight equivalent to six 🐘, one of the highest in the world.
>
> In order to meet the Paris Agreement goal of under 1.5°C rise by 2050, average per person emissions would need to be around 2,000 Kg per person by 2030. It has been suggested that countries over the average be carbon taxed and the funds raised given to countries under the average."

# ╔═╡ 5275094c-3e2a-4221-8a70-a179b77519ac
Resource("https://upload.wikimedia.org/wikipedia/commons/4/4b/Qatar_Product_Exports_%282019%29.svg?raw=true" , :width=>700)

# ╔═╡ e43d4a52-37bb-4f2e-bd07-04676973aa82
md" # ⚡Energy policy of Qatar⚡
...
>* The size and quality of expatriate labour force and selected path of development
...
> 800MWp Al Kharsaah plant constructed on a 1,000-hectare terrain, equivalent to ~ 1,400 football pitches.It can supply 10% of Qatar’s peak power consumption and will avoid 26 million tons of CO2 emissions over the course of its lifetime.
Electricity production from Natual Gas in 2020 was 50,000 GWh."

# ╔═╡ 598549f4-1344-4d25-bd5d-fbf215ac04b6
cs = distinguishable_colors(18)

# ╔═╡ 50d3b72d-c8cf-4c17-9af3-5ee2366ad892
md" ## Final Total Consumption in 1980 (80.3PJ)"
...
# ╔═╡ 499fc0aa-586e-4a71-913f-b4de7ed8eca4
Resource("https://github.com/raman-maker/Raman.github.io/blob/master/1980%20Qatar.svg?raw=true", :width=>700)

# ╔═╡ 4d7da16f-87cd-4584-a7e8-99827b036a70
md" ## Final Total Consumption in 2020 (910.7PJ) 
  Since 1980 Total consumption of _India_ has increased 4-times while of _Qatar_ increased 11-times . "
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "694edda5d8022f7e28e32aee2ebed8e2789c9caa"
